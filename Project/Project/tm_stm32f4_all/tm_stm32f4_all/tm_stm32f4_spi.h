...
@verbatim
 ...
 Version 1.6
  - March 05, 2015
  - Added 2 new functions, SPI_InitFull and SPI_GetPrescalerFromMaxFrequency()
 
 Version 1.5	
  - January 13, 2015
  - Added function SPI_InitWithMode() to initialize SPI with custom SPI mode on the fly
