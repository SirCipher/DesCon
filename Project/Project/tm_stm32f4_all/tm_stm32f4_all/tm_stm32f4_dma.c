...
void DMA_ClearFlags(DMA_Stream_TypeDef* DMA_Stream) {
	/* Clear all flags */
	DMA_ClearFlag(DMA_Stream, DMA_FLAG_ALL);
}

void DMA_ClearFlag(DMA_Stream_TypeDef* DMA_Stream, uint32_t flag) {
	uint32_t location;
...
uint32_t DMA_GetFlags(DMA_Stream_TypeDef* DMA_Stream, uint32_t flag) {
...
/*****************************************************************/
__weak void DMA_TransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_TransferCompleteHandler could be implemented in the user file
	*/
}

__weak void DMA_HalfTransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_HalfTransferCompleteHandler could be implemented in the user file
	*/
}

__weak void DMA_TransferErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_TransferErrorHandler could be implemented in the user file
	*/
}

__weak void DMA_DirectModeErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_DirectModeErrorHandler could be implemented in the user file
	*/
}

__weak void DMA_FIFOErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_FIFOErrorHandler could be implemented in the user file
	*/
}
...
static void DMA_INT_ProcessInterrupt(DMA_Stream_TypeDef* DMA_Stream) {
	...
	uint16_t flags = DMA_GetFlags(DMA_Stream, DMA_FLAG_ALL);
...
void DMA1_Stream0_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA1_Stream0);
}
#endif
#ifndef DMA1_STREAM1_DISABLE_IRQHANDLER
void DMA1_Stream1_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA1_Stream1);
}
#endif
#ifndef DMA1_STREAM2_DISABLE_IRQHANDLER
void DMA1_Stream2_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA1_Stream2);
}
#endif
...
void DMA1_Stream5_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA1_Stream5);
}
#endif
#ifndef DMA1_STREAM6_DISABLE_IRQHANDLER
void DMA1_Stream6_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA1_Stream6);
}
#endif
#ifndef DMA1_STREAM7_DISABLE_IRQHANDLER
void DMA1_Stream7_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA1_Stream7);
}
#endif
...
void DMA2_Stream1_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA2_Stream1);
}
#endif
...
void DMA2_Stream4_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA2_Stream4);
}
#endif
#ifndef DMA2_STREAM5_DISABLE_IRQHANDLER
void DMA2_Stream5_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA2_Stream5);
}
#endif
#ifndef DMA2_STREAM6_DISABLE_IRQHANDLER
void DMA2_Stream6_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA2_Stream6);
}
#endif
#ifndef DMA2_STREAM7_DISABLE_IRQHANDLER
void DMA2_Stream7_IRQHandler(void) {
	/* Call user function */
	DMA_INT_ProcessInterrupt(DMA2_Stream7);
}
#endif
