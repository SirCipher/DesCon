...
void MFRC522_Init(void) {
	MFRC522_InitPins();
	SPI_Init(MFRC522_SPI, MFRC522_SPI_PINSPACK);
...
void MFRC522_WriteRegister(uint8_t addr, uint8_t val) {
	...
	MFRC522_CS_LOW;
	//Send address
	SPI_Send(MFRC522_SPI, (addr << 1) & 0x7E);
	//Send data	
	SPI_Send(MFRC522_SPI, val);
	//CS high
	MFRC522_CS_HIGH;
}
...
uint8_t MFRC522_ReadRegister(uint8_t addr) {
	...
	SPI_Send(MFRC522_SPI, ((addr << 1) & 0x7E) | 0x80);	
	val = SPI_Send(MFRC522_SPI, MFRC522_DUMMY);
	//CS high
	MFRC522_CS_HIGH;
