...
//#define FATFS_DEBUG_SEND_USART(x)	USART_Puts(USART6, x); USART_Puts(USART6, "\n");
 ...
 * @param  DriverName: User can use 2 custom drivers. This parameter can be a value of @ref FATFS_Driver_t enumeration
 * @retval None
 */
